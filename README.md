...
- Registro de medidas protetivas com status (`Valid`, `Revoked`, `Expired`).
- Registro de prorrogações de medidas protetivas.
...
- **Medida Protetiva**: vínculo judicial com status e histórico de prorrogações.
...
- `victims`
- `offenders`
- `protective-measures` + `extensions`
- `attendance-victims`
...
- Restrições de negócio no banco, por exemplo:
  ...
  - 1 medida protetiva ativa (`status = Valid`) por vítima
...
- `protective_measures`, `protective_measure_extensions`
