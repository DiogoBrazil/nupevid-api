    ...
    cfg.service(
        web::scope("/work-sessions")
            ...
            .route(
                ...
                web::delete().to(work_sessions::remove_member),
            )
            .route(
                "/{id}/members",
                web::put().to(work_sessions::update_members),
            )
            .route(
                "/{id}/members/{user_id}/function",
                web::put().to(work_sessions::update_member_function),
            ),
    );
}
