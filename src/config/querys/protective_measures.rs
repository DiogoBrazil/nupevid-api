...
impl ProtectiveMeasuresQueries {
    pub const CREATE_PROTECTIVE_MEASURE: &'static str = r#"
        INSERT INTO protective_measures (id, process_number, issued_at, valid_until, judicial_authority, court_district_id, is_active, victim_id)
        VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
        RETURNING id, process_number, issued_at, valid_until, judicial_authority, court_district_id, is_active, victim_id, created_at, updated_at, is_deleted
    "#;

    pub const GET_PROTECTIVE_MEASURE_BY_ID: &'static str = r#"
        SELECT id, process_number, issued_at, valid_until, judicial_authority, court_district_id, is_active, victim_id, created_at, updated_at, is_deleted
    ...
    pub const UPDATE_PROTECTIVE_MEASURE_BY_ID: &'static str = r#"
        ...
        SET process_number = $2, issued_at = $3, valid_until = $4, judicial_authority = $5, court_district_id = $6, is_active = $7, victim_id = $8
        WHERE id = $1 AND is_deleted = false
        RETURNING id, process_number, issued_at, valid_until, judicial_authority, court_district_id, is_active, victim_id, created_at, updated_at, is_deleted
    "#;
