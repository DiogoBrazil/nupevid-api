...
impl VictimsQueries {
    pub const CREATE_VICTIM: &'static str = r#"
        INSERT INTO victims (id, full_name, cpf, birth_date, phone, city_id)
        VALUES ($1, $2, $3, $4, $5, $6)
        RETURNING id, full_name, cpf, birth_date, phone, city_id, created_at, updated_at, is_deleted
    "#;

    pub const GET_VICTIM_BY_ID: &'static str = r#"
        SELECT id, full_name, cpf, birth_date, phone, city_id, created_at, updated_at, is_deleted
        FROM victims
    ...
    pub const UPDATE_VICTIM_BY_ID: &'static str = r#"
        UPDATE victims
        SET full_name = $2, cpf = $3, birth_date = $4, phone = $5, city_id = $6
        WHERE id = $1 AND is_deleted = false
        RETURNING id, full_name, cpf, birth_date, phone, city_id, created_at, updated_at, is_deleted
    "#;
